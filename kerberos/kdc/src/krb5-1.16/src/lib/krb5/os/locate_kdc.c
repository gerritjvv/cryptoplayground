              ...
              k5_transport transport)
{
    ...
    *serverlist = list;
     ...
     * empty list. */
    printf("locate_kdc.c locate_server: realm=>%s, svc=>%d, transport=>%d\n", realm->data, (int)svc, (int)transport);
    ...
    printf("locate_kdc.c prof_locate_server: realm=>%s, svc=>%d, transport=>%d\n", realm->data, (int)svc, (int)transport);
